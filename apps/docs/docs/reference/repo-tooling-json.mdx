...
Read by [`@rtorcato/repo-ai`](https://github.com/rtorcato/repo-ai), which now owns the
ai-issue-loop pipeline. repo-tooling carries the key forward and never reads it.
